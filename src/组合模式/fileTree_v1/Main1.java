...
public class Main1 {
    ...
    public static void main(String[] args) {
        // 根目录
        FileSystemNode parentNode = new FileSystemNode("/Users/tangliang/code/node0", false);
        // 子目录
        FileSystemNode childNode1 = new FileSystemNode("/Users/tangliang/code/node0/node1", false);
        FileSystemNode childNode2 = new FileSystemNode("/Users/tangliang/code/node0/node2", false);
        FileSystemNode childNode3 = new FileSystemNode("/Users/tangliang/code/node0/node3", false);
        parentNode.addSubNode(childNode1);
        parentNode.addSubNode(childNode2);
        parentNode.addSubNode(childNode3);
        // 子目录下的文件
        FileSystemNode file1 = new FileSystemNode("/Users/tangliang/code/node0/node1/file1", true);
        FileSystemNode file2 = new FileSystemNode("/Users/tangliang/code/node0/node1/file2", true);
        childNode1.addSubNode(file1);
        childNode1.addSubNode(file2);
        FileSystemNode file3 = new FileSystemNode("/Users/tangliang/code/node0/node2/file3", true);
        childNode2.addSubNode(file3);
        FileSystemNode file4 = new FileSystemNode("/Users/tangliang/code/node0/node3/file4", true);
