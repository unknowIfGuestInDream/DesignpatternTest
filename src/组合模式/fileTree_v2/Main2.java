...
public class Main2 {
    ...
    public static void main(String[] args) {
        // 根目录
        DirectoryNode parentNode = new DirectoryNode("/Users/tangliang/code/node0");
        // 子目录
        DirectoryNode childNode1 = new DirectoryNode("/Users/tangliang/code/node0/node1");
        DirectoryNode childNode2 = new DirectoryNode("/Users/tangliang/code/node0/node2");
        DirectoryNode childNode3 = new DirectoryNode("/Users/tangliang/code/node0/node3");
        parentNode.addSubNode(childNode1);
        parentNode.addSubNode(childNode2);
        parentNode.addSubNode(childNode3);
        // 子目录下的文件
        FileNode file1 = new FileNode("/Users/tangliang/code/node0/node1/file1");
        FileNode file2 = new FileNode("/Users/tangliang/code/node0/node1/file2");
        childNode1.addSubNode(file1);
        childNode1.addSubNode(file2);
        FileNode file3 = new FileNode("/Users/tangliang/code/node0/node2/file3");
        childNode2.addSubNode(file3);
        FileNode file4 = new FileNode("/Users/tangliang/code/node0/node3/file4");
